...
class ServeCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        serve_parser.add_argument("--workers",type=int,default=1,help="Number of processes that of the serving.")
    ...
    def run(self):
        ...
        # see https://github.com/encode/uvicorn/search?p=2&q=workers&type=Issues
        run(self._app, host=self._host, port=self._port,workers=self._workers)
